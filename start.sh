...
PORT="${PORT:-5530}"
DB_NAME="${PGDATABASE:-mortgage_brokerage_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Mortgage Brokerage Operations Suite"
echo "======================================="
echo
...
echo "Starting mortgage brokerage operations suite frontend on http://localhost:$PORT"
echo "Login: admin@mortgage-brokerage-operations.local / admin123"
