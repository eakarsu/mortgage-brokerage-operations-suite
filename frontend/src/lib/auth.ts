export const AUTH_COOKIE = 'mortgage_brokerage_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@mortgage-brokerage-operations.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@mortgage-brokerage-operations.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@mortgage-brokerage-operations.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
