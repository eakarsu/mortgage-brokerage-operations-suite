...
const features = [
  {
    ...
    summary: 'Accounts workflow normalized for the Mortgage Brokerage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Finance',
    icon: Users,
    summary: 'Applications workflow normalized for the Mortgage Brokerage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Finance',
    icon: ClipboardList,
    summary: 'Transactions workflow normalized for the Mortgage Brokerage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Finance',
    icon: CalendarCheck,
    summary: 'Reviews workflow normalized for the Mortgage Brokerage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Activity,
    summary: 'Approvals workflow normalized for the Mortgage Brokerage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Workflow,
    summary: 'Exceptions workflow normalized for the Mortgage Brokerage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: FileText,
    summary: 'Risk Scores workflow normalized for the Mortgage Brokerage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: ShieldCheck,
    summary: 'Statements workflow normalized for the Mortgage Brokerage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: BarChart3,
    summary: 'Compliance workflow normalized for the Mortgage Brokerage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: PackageCheck,
    summary: 'Forecasts workflow normalized for the Mortgage Brokerage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Bell,
    summary: 'Analytics workflow normalized for the Mortgage Brokerage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Intelligence Layer',
    icon: Files,
    summary: 'Reports workflow normalized for the Mortgage Brokerage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Files,
    summary: 'Mortgage Brokerage Operations documents, packets, evidence, attachments, and exports.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Bell,
    summary: 'Mortgage Brokerage Operations alerts, reminders, exceptions, and approvals.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Plug,
    summary: 'Mortgage Brokerage Operations source-system connector health and sync status.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: UserRound,
    summary: 'Mortgage Brokerage Operations users, roles, teams, permissions, and ownership settings.',
...
const aiFeatures = [
  {
    ...
    category: 'Intelligence Layer',
    icon: Bot,
    summary: 'Mortgage Brokerage Operations assistant for triage, summaries, drafting, recommendations, and operational review.',
...
export const featureContexts: Record<string, FeatureContext> = Object.fromEntries(
  allFeatures.map((feature) => [
    feature.title,
    {
      sourceOwners: ['AIMortgageBrokerageOperationsAssistant', 'AIMortgageBrokerageOperationsOperations where applicable'],
